...
func InitOperator() {
	...
	operatorReferenceStore := synchronizer.NewOperatorReferenceStore()
	...
	if err := controllers.NewAPIController(mgr, operatorDataStore, operatorReferenceStore); err != nil {
	...
	go synchronizer.HandleAPILifeCycleEvents(operatorDataStore)
